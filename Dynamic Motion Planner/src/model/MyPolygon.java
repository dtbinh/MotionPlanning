...
*/
	...
	void calculateBounds(double xpoints[], double ypoints[], int npoints) {
		...
		bounds = new Rectangle2D.Double(boundsMinX, boundsMinY, boundsMaxX - boundsMinX,
	...
	public String toString(){
		String out = new String("Vertices ");
		for(int i=0; i<npoints; i++){
			out = out + " X: " + xpoints[i] + " Y: " + ypoints[i];
		}
		return out+"\n";
	}
	...
	public Polygon toPolygon(){
		...
		for(int i=0; i < this.npoints; i++)
			intPoly.addPoint((int)xpoints[i], (int)this.ypoints[i]);
		return intPoly;
	}
